  ...
  paths: {
    ...
    '/api/farms': {
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['farmName', 'size', 'district', 'sector', 'cell', 'village'],
                properties: {
                  farmName: { type: 'string', example: 'My Farm' },
                  size: { type: 'number', example: 2.5, description: 'Size in hectares' },
                  district: { type: 'string', example: 'Gasabo' },
                  sector: { type: 'string', example: 'Remera' },
                  cell: { type: 'string', example: 'Rukiri I' },
                  village: { type: 'string', example: 'Agatare' },
                  location: { type: 'string', example: 'Agatare, Rukiri I, Remera, Gasabo' },
                  soilType: { type: 'string', example: 'Clay loam' },
                  irrigationType: { type: 'string', enum: ['rain-fed', 'drip', 'sprinkler', 'flood', 'none'], example: 'rain-fed' },
                  currentCrop: { type: 'string', example: 'Maize' },
                  plantingDate: { type: 'string', format: 'date', example: '2024-03-15' },
                  expectedHarvestDate: { type: 'string', format: 'date', example: '2024-07-15' },
                  seedVariety: { type: 'string', example: 'H614' },
                  coordinates: {
                    type: 'object',
                    properties: {
                  ...
                  notes: { type: 'string', example: 'Near main road' }
                }
              }
            }
          }
            ...
            content: {
              'application/json': {
                schema: {
                  ...
                  properties: {
                    success: { type: 'boolean', example: true },
                    message: { type: 'string', example: 'Farm registered successfully' },
                    data: {
                      type: 'object',
                      properties: {
                        id: { type: 'string', format: 'uuid' },
      ...
      get: {
        tags: ['Farms'],
        summary: 'Get all user farms',
        description: 'Returns a paginated list of farms belonging to the authenticated user.',
        security: [{ bearerAuth: [] }],
        parameters: [
          {
            name: 'status',
            in: 'query',
            schema: { type: 'string', enum: ['active', 'inactive', 'fallow'] },
    ...
    '/api/farms/stats': {
      get: {
        ...
        description: 'Returns statistical data about user\'s farms.',
        security: [{ bearerAuth: [] }],
        responses: {
          200: {
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: 'object',
                      properties: {
                        totalFarms: { type: 'integer', example: 3 },
                        activeFarms: { type: 'integer', example: 2 },
                        totalArea: { type: 'number', example: 7.5, description: 'Total area in hectares' },
                        farmsByDistrict: {
                          type: 'array',
                          items: {
                            type: 'object',
    ...
    '/api/farms/{id}': {
      get: {
        ...
        description: 'Returns details of a specific farm owned by the authenticated user.',
        security: [{ bearerAuth: [] }],
        parameters: [
          {
            name: 'id',
      ...
      put: {
        tags: ['Farms'],
        summary: 'Update farm',
        description: 'Updates a farm owned by the authenticated user.',
        security: [{ bearerAuth: [] }],
        parameters: [
          {
            name: 'id',
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  location: { type: 'string' },
                  soilType: { type: 'string' },
                  irrigationType: { type: 'string', enum: ['rain-fed', 'drip', 'sprinkler', 'flood', 'none'] },
                  currentCrop: { type: 'string' },
                  plantingDate: { type: 'string', format: 'date' },
                  expectedHarvestDate: { type: 'string', format: 'date' },
                  seedVariety: { type: 'string' },
            ...
            content: {
              'application/json': {
                schema: {
                  ...
                  properties: {
                    success: { type: 'boolean', example: true },
                    message: { type: 'string', example: 'Farm updated successfully' },
                    data: { type: 'object' }
                  }
                }
              }
      ...
      delete: {
        tags: ['Farms'],
        summary: 'Delete farm',
        description: 'Deletes a farm owned by the authenticated user.',
        security: [{ bearerAuth: [] }],
        parameters: [
          {
            name: 'id',
